...
export const Route = createFileRoute("/apps/research-scout")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Varredura de fontes e sinais externos que alimenta a cadeia de oportunidade LAMOU." },
      { property: "og:title", content: "Research Scout — LAMOU" },
      { property: "og:description", content: "Varredura de fontes e sinais externos que alimenta a cadeia de oportunidade LAMOU." },
