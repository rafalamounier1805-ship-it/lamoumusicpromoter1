...
export const Route = createFileRoute("/apps/teste3")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Executor transversal de testes do ecossistema LAMOU, com evidência e reteste." },
      { property: "og:title", content: "Teste³ IA — LAMOU" },
      { property: "og:description", content: "Executor transversal de testes do ecossistema LAMOU, com evidência e reteste." },
