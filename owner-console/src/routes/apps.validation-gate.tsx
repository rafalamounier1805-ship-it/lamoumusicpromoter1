...
export const Route = createFileRoute("/apps/validation-gate")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gate que autoriza ou bloqueia promoção com base em evidência verificável." },
      { property: "og:title", content: "Validation Gate — LAMOU" },
      { property: "og:description", content: "Gate que autoriza ou bloqueia promoção com base em evidência verificável." },
