...
export const Route = createFileRoute("/apps/version")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Arquivos, builds, documentos, versionamento, retenção e deduplicação." },
      { property: "og:title", content: "LAMOU Version — Arquivos e Builds" },
      { property: "og:description", content: "Arquivos, builds, documentos, versionamento, retenção e deduplicação." },
