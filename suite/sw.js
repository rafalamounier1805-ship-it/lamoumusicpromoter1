const CACHE='lamou-central-official-20260824e';
const CORE=['./','./index.html','./styles.css','./dossier.css','./data.js','./app.js','./dossier-v2.js','./release-channels.js','./manifest.webmanifest','./icon.svg','./lamou-ia-logo-oficial.webp'];
